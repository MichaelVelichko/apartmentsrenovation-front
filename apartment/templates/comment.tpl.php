...
<article class="<?php print implode(' ', $classes); ?> clearfix"<?php print backdrop_attributes($attributes); ?>>
  ...
  <?php endif; ?>
   ...
   <div class="autore"> <?php print $user_picture; ?></div>
 <div class="content-comment"<?php print backdrop_attributes($content_attributes); ?>>
  <p class="autore-name"><?php print $submitted; ?><?php print $permalink; ?></p> 
    <?php
